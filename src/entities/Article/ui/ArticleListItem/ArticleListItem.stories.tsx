...
Primary_Small.decorators = [ThemeDecorator(Theme.LIGHT)]
...
Primary_Big.decorators = [ThemeDecorator(Theme.LIGHT)]

export const Dark_Small = Template.bind({});
Dark_Small.args = {
    article,
    view: ArticleView.SMALL
};
Dark_Small.decorators = [ThemeDecorator(Theme.DARK)]
...
export const Olive_Small = Template.bind({});
Olive_Small.args = {
    article,
    view: ArticleView.SMALL
};
Olive_Small.decorators = [ThemeDecorator(Theme.OLIVE)]
