...
import { ArticleBlockType, ArticleType } from "entities/Article/model/types/artiicle";
...
describe('articleDetailsSlice.test', () => {
    test('test fetchArticleById service pending', () => {
        const state: DeepPartial<ArticleDetailsSchema> = { error: 'Bla-bla', isLoading: false }
    ...
    test('test fetchArticleById service fulfilled', () => {
        ...
        expect(articleDetailsReducer(
            ...
            .toEqual({ isLoading: false, data: articleData })
    })
})
